...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | STRUCT
    | STRING of (
# 12 "lachaize/src/parser.mly"
       (string)
# 19 "lachaize/src/parser.ml"
  )
    | STAR
    | SLASH
    | SEMICOLON
    ...
    | IF
    | IDENT of (
# 11 "lachaize/src/parser.mly"
       (string)
# 41 "lachaize/src/parser.ml"
  )
    | FUNC
    | FOR
    | EQ
    ...
    | DOT
    | CST of (
# 10 "lachaize/src/parser.mly"
       (Ast.constant)
# 52 "lachaize/src/parser.ml"
  )
    | COMP of (
# 22 "lachaize/src/parser.mly"
       (Ast.binop)
# 57 "lachaize/src/parser.ml"
  )
    | COMMA
    | COLONEQ
    | BANG
...
# 4 "lachaize/src/parser.mly"
  
  open Ast
  let mk_expr loc d = { pexpr_desc = d; pexpr_loc = loc }
  exception Error 

# 75 "lachaize/src/parser.ml"
...
# 229 "<standard.mly>"
    ( xs )
# 553 "lachaize/src/parser.ml"
     in
    (
# 232 "lachaize/src/parser.mly"
  ( l )
# 558 "lachaize/src/parser.ml"
     : (Ast.pexpr list))
...
let _menhir_action_02 =
  fun _endpos__2_ _startpos__1_ ->
    ...
    (
# 104 "lachaize/src/parser.mly"
  ( { pexpr_desc = PEblock []; pexpr_loc = _startpos, _endpos } )
# 568 "lachaize/src/parser.ml"
     : (Ast.pexpr))
...
let _menhir_action_03 =
  fun _endpos__3_ _startpos__1_ l ->
    ...
    let _startpos = _startpos__1_ in
    (
# 106 "lachaize/src/parser.mly"
  ( { pexpr_desc = PEblock l; pexpr_loc = _startpos, _endpos } )
# 578 "lachaize/src/parser.ml"
     : (Ast.pexpr))
...
# 132 "<standard.mly>"
    ( true )
# 594 "lachaize/src/parser.ml"
     : (bool))

let _menhir_action_06 =
  fun b id pl ty ->
    (
# 63 "lachaize/src/parser.mly"
  ( PDfunction { pf_name = id;
                 pf_params = List.flatten pl;
                 pf_typ = ty;
                 pf_body = b } )
# 605 "lachaize/src/parser.ml"
     : (Ast.pdecl))

let _menhir_action_07 =
  fun fl id ->
    (
# 68 "lachaize/src/parser.mly"
  ( PDstruct { ps_name = id; ps_fields = List.flatten fl; } )
# 613 "lachaize/src/parser.ml"
     : (Ast.pdecl))
...
let _menhir_action_08 =
  fun _endpos_d_ _startpos_d_ d ->
    ...
    (
# 196 "lachaize/src/parser.mly"
  ( { pexpr_desc = d; pexpr_loc = _startpos, _endpos } )
# 623 "lachaize/src/parser.ml"
     : (Ast.pexpr))

let _menhir_action_09 =
  fun c ->
    (
# 201 "lachaize/src/parser.mly"
    ( PEconstant c )
# 631 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_10 =
  fun s ->
    (
# 203 "lachaize/src/parser.mly"
    ( PEconstant (Cstring s) )
# 639 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_11 =
  fun () ->
    (
# 205 "lachaize/src/parser.mly"
    ( PEnil )
# 647 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_12 =
  fun e ->
    (
# 207 "lachaize/src/parser.mly"
  ( e.pexpr_desc )
# 655 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_13 =
  fun id ->
    (
# 209 "lachaize/src/parser.mly"
   ( PEident id )
# 663 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_14 =
  fun e id ->
    (
# 211 "lachaize/src/parser.mly"
   ( PEdot (e, id) )
# 671 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_15 =
  fun el id ->
    (
# 213 "lachaize/src/parser.mly"
   ( PEcall (id, el) )
# 679 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_16 =
  fun e el id ->
    (
# 215 "lachaize/src/parser.mly"
   ( match e.pexpr_desc, id.id with
     | PEident {id="fmt"}, "Print" -> PEcall ({id with id = "fmt.Print"}, el)
     | _ -> raise Error )
# 689 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_17 =
  fun e1 e2 ->
    let op = 
# 236 "lachaize/src/parser.mly"
             ( Badd )
# 697 "lachaize/src/parser.ml"
     in
    (
# 219 "lachaize/src/parser.mly"
  ( PEbinop (op, e1, e2) )
# 702 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_18 =
  fun e1 e2 ->
    let op = 
# 237 "lachaize/src/parser.mly"
             ( Bsub )
# 710 "lachaize/src/parser.ml"
     in
    (
# 219 "lachaize/src/parser.mly"
  ( PEbinop (op, e1, e2) )
# 715 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_19 =
  fun e1 e2 ->
    let op = 
# 238 "lachaize/src/parser.mly"
             ( Bmul )
# 723 "lachaize/src/parser.ml"
     in
    (
# 219 "lachaize/src/parser.mly"
  ( PEbinop (op, e1, e2) )
# 728 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_20 =
  fun e1 e2 ->
    let op = 
# 239 "lachaize/src/parser.mly"
             ( Bdiv )
# 736 "lachaize/src/parser.ml"
     in
    (
# 219 "lachaize/src/parser.mly"
  ( PEbinop (op, e1, e2) )
# 741 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_21 =
  fun e1 e2 ->
    let op = 
# 240 "lachaize/src/parser.mly"
             ( Bmod )
# 749 "lachaize/src/parser.ml"
     in
    (
# 219 "lachaize/src/parser.mly"
  ( PEbinop (op, e1, e2) )
# 754 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_22 =
  fun c e1 e2 ->
    let op = 
# 241 "lachaize/src/parser.mly"
             ( c )
# 762 "lachaize/src/parser.ml"
     in
    (
# 219 "lachaize/src/parser.mly"
  ( PEbinop (op, e1, e2) )
# 767 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_23 =
  fun e1 e2 ->
    let op = 
# 242 "lachaize/src/parser.mly"
                           ( Band )
# 775 "lachaize/src/parser.ml"
     in
    (
# 219 "lachaize/src/parser.mly"
  ( PEbinop (op, e1, e2) )
# 780 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_24 =
  fun e1 e2 ->
    let op = 
# 243 "lachaize/src/parser.mly"
                           ( Bor  )
# 788 "lachaize/src/parser.ml"
     in
    (
# 219 "lachaize/src/parser.mly"
  ( PEbinop (op, e1, e2) )
# 793 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_25 =
  fun e1 ->
    (
# 221 "lachaize/src/parser.mly"
  ( PEunop (Unot, e1) )
# 801 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_26 =
  fun e1 ->
    (
# 223 "lachaize/src/parser.mly"
  ( PEunop (Uneg, e1) )
# 809 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_27 =
  fun e1 ->
    (
# 225 "lachaize/src/parser.mly"
  ( PEunop (Uamp, e1) )
# 817 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_28 =
  fun e1 ->
    (
# 227 "lachaize/src/parser.mly"
  ( PEunop (Ustar, e1) )
# 825 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_29 =
  fun el ->
    (
# 191 "lachaize/src/parser.mly"
                                            ( el )
# 833 "lachaize/src/parser.ml"
     : (Ast.pexpr list))

let _menhir_action_30 =
  fun x ->
    (
# 72 "lachaize/src/parser.mly"
                                           ( [x]     )
# 841 "lachaize/src/parser.ml"
     : (Ast.pfield list list))

let _menhir_action_31 =
  fun x xl ->
    (
# 73 "lachaize/src/parser.mly"
                                           ( x :: xl )
# 849 "lachaize/src/parser.ml"
     : (Ast.pfield list list))

let _menhir_action_32 =
  fun dl imp ->
    (
# 48 "lachaize/src/parser.mly"
  ( imp, dl )
# 857 "lachaize/src/parser.ml"
     : (Ast.pfile))
...
let _menhir_action_33 =
  fun _endpos_id_ _startpos_id_ id ->
    ...
    (
# 247 "lachaize/src/parser.mly"
             ( { loc = _startpos, _endpos; id = id } )
# 867 "lachaize/src/parser.ml"
     : (Ast.ident))

let _menhir_action_34 =
  fun id ->
    (
# 52 "lachaize/src/parser.mly"
             ( if id.id <> "main" then raise Error )
# 875 "lachaize/src/parser.ml"
     : (unit))

let _menhir_action_35 =
  fun ids ty ->
    (
# 82 "lachaize/src/parser.mly"
   ( List.map (fun x -> x, ty) ids )
# 883 "lachaize/src/parser.ml"
     : (Ast.pfield list))
...
let _menhir_action_36 =
  fun _endpos_d_ _startpos_d_ d ->
    ...
    let _startpos = _startpos_d_ in
    (
# 149 "lachaize/src/parser.mly"
    ( { pexpr_desc = d; pexpr_loc = _startpos, _endpos } )
# 893 "lachaize/src/parser.ml"
     : (Ast.pexpr))
...
let _menhir_action_37 =
  fun _endpos_s_ _startpos__1_ e s ->
    ...
    let _startpos = _startpos__1_ in
    (
# 154 "lachaize/src/parser.mly"
  ( PEif (e, s, { pexpr_desc = PEskip; pexpr_loc = _startpos, _endpos }) )
# 903 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_38 =
  fun e s1 s2 ->
    (
# 156 "lachaize/src/parser.mly"
  ( PEif (e, s1, s2) )
# 911 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_39 =
  fun e s1 s2 ->
    (
# 158 "lachaize/src/parser.mly"
  ( PEif (e, s1, s2) )
# 919 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_40 =
  fun s ->
    (
# 56 "lachaize/src/parser.mly"
                            ( if s <> "fmt" then raise Error )
# 927 "lachaize/src/parser.ml"
     : (unit))

let _menhir_action_41 =
  fun () ->
    (
# 186 "lachaize/src/parser.mly"
             ( Inc )
# 935 "lachaize/src/parser.ml"
     : (Ast.incdec))

let _menhir_action_42 =
  fun () ->
    (
# 187 "lachaize/src/parser.mly"
             ( Dec )
# 943 "lachaize/src/parser.ml"
     : (Ast.incdec))

let _menhir_action_43 =
  fun el ->
    (
# 161 "lachaize/src/parser.mly"
              ( el )
# 951 "lachaize/src/parser.ml"
     : (Ast.pexpr list))
...
let _menhir_action_56 =
  fun _endpos__0_ ->
    ...
    (
# 165 "lachaize/src/parser.mly"
                  ( { pexpr_desc = PEskip; pexpr_loc = _startpos, _endpos } )
# 1057 "lachaize/src/parser.ml"
     : (Ast.pexpr))

let _menhir_action_57 =
  fun s ->
    (
# 166 "lachaize/src/parser.mly"
                  ( s )
# 1065 "lachaize/src/parser.ml"
     : (Ast.pexpr))
...
# 113 "<standard.mly>"
    ( Some x )
# 1113 "lachaize/src/parser.ml"
     : (Ast.ptyp option))

let _menhir_action_64 =
  fun x ->
    (
# 76 "lachaize/src/parser.mly"
                                           ( [x]     )
# 1121 "lachaize/src/parser.ml"
     : (Ast.pfield list list))

let _menhir_action_65 =
  fun x xl ->
    (
# 77 "lachaize/src/parser.mly"
                                           ( x :: xl )
# 1129 "lachaize/src/parser.ml"
     : (Ast.pfield list list))

let _menhir_action_66 =
  fun ty ->
    (
# 86 "lachaize/src/parser.mly"
                                               ( [ty] )
# 1137 "lachaize/src/parser.ml"
     : (Ast.ptyp list))

let _menhir_action_67 =
  fun tyl ->
    (
# 87 "lachaize/src/parser.mly"
                                      ( tyl )
# 1145 "lachaize/src/parser.ml"
     : (Ast.ptyp list))

let _menhir_action_68 =
  fun ty ->
    (
# 91 "lachaize/src/parser.mly"
                                            ( [ty] )
# 1153 "lachaize/src/parser.ml"
     : (Ast.ptyp list))

let _menhir_action_69 =
  fun ty tyl ->
    (
# 92 "lachaize/src/parser.mly"
                                            ( ty :: tyl )
# 1161 "lachaize/src/parser.ml"
     : (Ast.ptyp list))
...
# 240 "<standard.mly>"
    ( x :: xs )
# 1193 "lachaize/src/parser.ml"
     : (Ast.ident list))

let _menhir_action_74 =
  fun e ->
    (
# 171 "lachaize/src/parser.mly"
  ( e )
# 1201 "lachaize/src/parser.ml"
     : (Ast.pexpr))
...
let _menhir_action_75 =
  fun _endpos_d_ _startpos_d_ d ->
    ...
    let _startpos = _startpos_d_ in
    (
# 173 "lachaize/src/parser.mly"
  ( { pexpr_desc = d; pexpr_loc = _startpos, _endpos } )
# 1211 "lachaize/src/parser.ml"
     : (Ast.pexpr))

let _menhir_action_76 =
  fun el lvl ->
    (
# 177 "lachaize/src/parser.mly"
  ( PEassign (lvl, el) )
# 1219 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_77 =
  fun el lvl ->
    (
# 179 "lachaize/src/parser.mly"
  ( let var = function {pexpr_desc=PEident id} -> id | _ -> raise Error in
    PEvars (List.map var lvl, None, el) )
# 1228 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_78 =
  fun e i ->
    (
# 182 "lachaize/src/parser.mly"
  ( PEincdec (e, i) )
# 1236 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_79 =
  fun s ->
    (
# 110 "lachaize/src/parser.mly"
                                ( [s]    )
# 1244 "lachaize/src/parser.ml"
     : (Ast.pexpr list))

let _menhir_action_80 =
  fun s ->
    (
# 111 "lachaize/src/parser.mly"
                                ( [s]    )
# 1252 "lachaize/src/parser.ml"
     : (Ast.pexpr list))

let _menhir_action_81 =
  fun l s ->
    (
# 112 "lachaize/src/parser.mly"
                                ( s :: l )
# 1260 "lachaize/src/parser.ml"
     : (Ast.pexpr list))

let _menhir_action_82 =
  fun l ->
    (
# 113 "lachaize/src/parser.mly"
                                ( l      )
# 1268 "lachaize/src/parser.ml"
     : (Ast.pexpr list))

let _menhir_action_83 =
  fun () ->
    (
# 114 "lachaize/src/parser.mly"
                                ( []     )
# 1276 "lachaize/src/parser.ml"
     : (Ast.pexpr list))

let _menhir_action_84 =
  fun s ->
    (
# 119 "lachaize/src/parser.mly"
    ( s )
# 1284 "lachaize/src/parser.ml"
     : (Ast.pexpr))

let _menhir_action_85 =
  fun b ->
    (
# 121 "lachaize/src/parser.mly"
    ( b )
# 1292 "lachaize/src/parser.ml"
     : (Ast.pexpr))

let _menhir_action_86 =
  fun s ->
    (
# 123 "lachaize/src/parser.mly"
    ( s )
# 1300 "lachaize/src/parser.ml"
     : (Ast.pexpr))
...
let _menhir_action_87 =
  fun _endpos_d_ _startpos_d_ d ->
    ...
    let _startpos = _startpos_d_ in
    (
# 125 "lachaize/src/parser.mly"
    ( { pexpr_desc = d; pexpr_loc = _startpos, _endpos } )
# 1310 "lachaize/src/parser.ml"
     : (Ast.pexpr))

let _menhir_action_88 =
  fun i ids ty ->
    (
# 131 "lachaize/src/parser.mly"
  ( PEvars (ids, ty, i) )
# 1318 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))
...
# 229 "<standard.mly>"
    ( xs )
# 1326 "lachaize/src/parser.ml"
     in
    (
# 133 "lachaize/src/parser.mly"
  ( PEreturn el )
# 1331 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))
...
let _menhir_action_90 =
  fun _endpos_b_ _startpos__1_ b ->
    ...
    let _startpos = _startpos__1_ in
    (
# 135 "lachaize/src/parser.mly"
  ( let loc = _startpos, _endpos in
    let etrue = mk_expr loc (PEconstant (Cbool true)) in
    PEfor (etrue, b) )
# 1343 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_91 =
  fun b e1 ->
    (
# 139 "lachaize/src/parser.mly"
  ( PEfor (e1, b) )
# 1351 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))
...
let _menhir_action_92 =
  fun _endpos_b_ _startpos__1_ b e2 s1 s3 ->
    ...
    let _startpos = _startpos__1_ in
    (
# 142 "lachaize/src/parser.mly"
  ( let loc = _startpos, _endpos in
    let b = mk_expr loc (PEblock [b; s3]) in
    PEblock [s1; mk_expr loc (PEfor (e2, b))] )
# 1363 "lachaize/src/parser.ml"
     : (Ast.pexpr_desc))

let _menhir_action_93 =
  fun id ->
    (
# 97 "lachaize/src/parser.mly"
   ( PTident id )
# 1371 "lachaize/src/parser.ml"
     : (Ast.ptyp))

let _menhir_action_94 =
  fun ty ->
    (
# 99 "lachaize/src/parser.mly"
   ( PTptr ty )
# 1379 "lachaize/src/parser.ml"
     : (Ast.ptyp))
